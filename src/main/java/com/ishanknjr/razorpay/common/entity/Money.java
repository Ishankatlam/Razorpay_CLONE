...
public class Money {
    ...
    public Money add(Money other)
    {
        ...
        {
            throw new IllegalArgumentException("Cannot add money with different curriencies ");
        }
    ...
    public Money subtract(Money other)
    {
        if(!this.currency.equals(other.currency))
        {
            throw new IllegalArgumentException("Cannot subtract money with different curriencies ");
        }
        return new Money(this.amountUnits- other.amountUnits ,this.currency);
    }
